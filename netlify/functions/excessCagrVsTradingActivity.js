// excessCagrVsTradingActivity.js
...
/**
 * Create a scatter chart with regression line that shows excess CAGR vs. total trades.
 * @param {HTMLCanvasElement} canvas - The canvas element to render the chart on.
 * @param {Array<Object>} visitorData - An array of visitor documents.
 ...
 *           - buyHoldCAGR (number)
 */
export async function createExcessCagrChart(canvas, visitorData) {
